...
const app = {
    ...
    handleEvents: function(){
        ...
        btnPlay.addEventListener("click", function(){
            ...
            audio.onplay = function(){
                ...
                const listHtmlSong = $$(".song")
                _this.activeSong(listHtmlSong)  
            }
    ...
    activeSong: function(listHtmlSong){
        listHtmlSong[this.currentIndex].classList.add('active');
        for (let i in listHtmlSong ){
            if (i != this.currentIndex){
                listHtmlSong[i].classList.remove('active');
            }
        }
    },
    start: function(){
